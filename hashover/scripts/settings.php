...
{
	// Required setup
	public    $notificationEmail	= 'umacha123@naver.com';	// E-mail for notification of new comments
	protected $encryptionKey	= 'abcdefgh';			// Unique encryption key
	protected $adminName		= 'ParkShinHyun92';			// Login name to gain admin rights (case-sensitive)
	protected $adminPassword	= 'qwe5034906!';			// Login password to gain admin rights (case-sensitive)
